...
part 'address_form_screen_extension.dart';

class AddressFormScreen extends StatefulWidget {
  // final Function? onNext;

  // const AddressFormScreen({this.onNext});
  final bool isFromEdit;
  final int? editAddressIndex;
  const AddressFormScreen({required this.isFromEdit, this.editAddressIndex});
  ...
  void initState() {
    ...
    for (var config in Configurations.addressFields) {
      ...
      if (config.type == AddressFieldType.firstName ||
        ...
        _configs[index]?.visible = false;
      }
      // print('config required =========================================== ${config.required} ${config.type}');
      // print('config type =========================================== ${config.type}');
      _fieldPosition[index] = config.type;
    }
    // print('configs =========================================== ${_configs}');
    // print(
        // 'field position =========================================== ${_fieldPosition}');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.isFromEdit==true?'Edita tu Dirección':
                    ...
                    child: Column(
                      ...
                      children: List.generate(
                        _fieldPosition.length,
                          ...
                          //             MaterialPageRoute(
                          //               builder: (context) =>
                          //                   ManageAddressScreen(callback: updateAddress,),
                          //             ),
                          //           );
                          //         },
                          //         child: Row(
